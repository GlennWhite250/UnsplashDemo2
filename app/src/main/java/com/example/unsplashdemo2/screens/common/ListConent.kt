...
import com.example.unsplashdemo2.R
import com.example.unsplashdemo2.model.UnsplashImage
import com.example.unsplashdemo2.model.Urls
import com.example.unsplashdemo2.model.User
import com.example.unsplashdemo2.model.UserLinks
import com.example.unsplashdemo2.ui.theme.HeartRed
...
fun UnsplashImagePreview(){
    UnsplashItem(unsplashImage = UnsplashImage(
        ...
        urls = Urls(regular = ""),
        likes = 100,
        user = User(username = "Glenn White", userLinks = UserLinks(html = ""))
    ))
}